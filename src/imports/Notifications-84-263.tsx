...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[8px] items-start px-[12px] py-[8px] relative rounded-[100px] shrink-0">
      ...
      <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[17px] text-black whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        10:00 am
      </p>
    </div>
  );
...
function Frame8() {
  return (
    <div className="bg-[#212121] content-stretch flex gap-[8px] items-start px-[12px] py-[8px] relative rounded-[100px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.38)] border-solid inset-[-1px] pointer-events-none rounded-[101px]" />
      <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[17px] text-white whitespace-nowrap" style={{ fontVariationSettings: "'opsz' 14" }}>
        5:00 pm
      </p>
    </div>
  );
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <Loader />
      <Frame14 />
      <div className="content-start flex flex-wrap gap-[16px] items-start py-[16px] relative shrink-0 w-full" data-name="Times">
        <Frame7 />
        <Frame6 />
        <Frame8 />
        <Frame9 />
