import imgOnboarding3 from "../assets/2e8578a52c5018732167a6f017ef32a7b8124e18.png";
...
export default function Onboarding({ progress = 0 }: { progress?: number }) {
  return (
    <div className="content-stretch flex flex-col items-start px-[16px] relative min-h-screen" data-name="Onboarding-3">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgOnboarding3} />
