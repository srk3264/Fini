  ...
  return (
    <div className="bg-[rgba(33,33,33,0.12)] relative rounded-[100px] shrink-0 w-full" data-name="loader">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center pr-[158px] relative w-full">
...
export default function Status() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-between px-[16px] relative size-full" data-name="status">
      <Frame13 />
      <Frame8 />
    </div>
  );
