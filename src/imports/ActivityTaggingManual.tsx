import svgPaths from "./svg-2phl5h25y7";
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex inset-[20.46px_34px_49.51px_226px] items-center">
      <div className="flex h-[26.034px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="-rotate-90 flex-none">
          <div className="h-0 relative w-[26.034px]">
            <div className="absolute inset-[-5.33px_-20.49%_-5.33px_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.3674 10.6667">
                <path d={svgPaths.pc8dd980} fill="var(--stroke-0, black)" id="Line 1" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="bg-[rgba(0,0,0,0.08)] flex-[1_0_0] h-full min-h-px min-w-px" />
      <div className="flex h-[26.034px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="-scale-y-100 flex-none rotate-90">
          <div className="h-0 relative w-[26.034px]">
            <div className="absolute inset-[-5.33px_-20.49%_-5.33px_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 31.3674 10.6667">
                <path d={svgPaths.pc8dd980} fill="var(--stroke-0, black)" id="Line 2" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame7() {
  return <div className="bg-[#ffcf48] rounded-[33.333px] shrink-0 size-[8px]" />;
}

function Frame8() {
  return <div className="bg-[#9bccff] rounded-[33.333px] shrink-0 size-[8px]" />;
}

function Frame9() {
  return <div className="bg-[#7dc66b] rounded-[33.333px] shrink-0 size-[8px]" />;
}

function Frame10() {
  return <div className="bg-[#e86a2a] rounded-[33.333px] shrink-0 size-[8px]" />;
}
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full">
      <div className="content-stretch flex flex-col gap-[24px] items-start py-[24px] relative size-full">
        ...
        <div className="absolute bg-white content-stretch flex flex-col gap-[8px] items-start left-[271px] px-[12px] py-[8px] rounded-[16px] top-[456px] w-[119px]" data-name="activity tagging menu">
          <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.12)] border-solid inset-[-1px] pointer-events-none rounded-[17px]" />
          <div className="content-stretch flex gap-[4px] items-center px-[2px] py-[4px] relative rounded-[100px] shrink-0 w-[95px]" data-name="Component 7">
            <Frame7 />
            <p className="flex-[1_0_0] font-['DM_Sans:Medium',sans-serif] font-medium leading-[1.3] min-h-px min-w-px relative text-[11px] text-[rgba(0,0,0,0.6)]" style={{ fontVariationSettings: "'opsz' 14" }}>
              Reflections
            </p>
          </div>
          <div className="content-stretch flex gap-[4px] items-center px-[2px] py-[4px] relative rounded-[100px] shrink-0 w-[95px]" data-name="Component 8">
            <Frame8 />
            <p className="flex-[1_0_0] font-['DM_Sans:Medium',sans-serif] font-medium leading-[1.3] min-h-px min-w-px relative text-[11px] text-[rgba(0,0,0,0.6)]" style={{ fontVariationSettings: "'opsz' 14" }}>
              Health
            </p>
          </div>
          <div className="bg-[rgba(155,204,255,0.08)] content-stretch flex gap-[4px] items-center p-[4px] relative rounded-[100px] shrink-0 w-[95px]" data-name="Component 9">
            <div aria-hidden="true" className="absolute border border-[#9bccff] border-solid inset-0 pointer-events-none rounded-[100px]" />
            <Frame9 />
            <p className="flex-[1_0_0] font-['DM_Sans:Medium',sans-serif] font-medium leading-[1.3] min-h-px min-w-px relative text-[11px] text-[rgba(0,0,0,0.6)]" style={{ fontVariationSettings: "'opsz' 14" }}>
              To do
            </p>
          </div>
          <div className="content-stretch flex gap-[4px] items-center px-[2px] py-[4px] relative rounded-[100px] shrink-0 w-[95px]" data-name="Component 10">
            <Frame10 />
            <p className="flex-[1_0_0] font-['DM_Sans:Medium',sans-serif] font-medium leading-[1.3] min-h-px min-w-px relative text-[11px] text-[rgba(0,0,0,0.6)]" style={{ fontVariationSettings: "'opsz' 14" }}>
              Reminders
            </p>
...
export default function ActivityTaggingManual() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-between px-[16px] relative size-full" data-name="activity tagging manual">
      <Frame14 />
      <Frame15 />
