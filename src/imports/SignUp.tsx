...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col h-[58px] gap-[8px]  items-start relative shrink-0 w-full">
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col font-['DM_Sans:Regular',sans-serif] font-normal gap-[4px] items-start relative shrink-0 text-center w-full">
      <p className="leading-[18px] relative shrink-0 text-[13px] text-[rgba(0,0,0,0.6)] w-full" style={{ fontVariationSettings: "'opsz' 14" }}>
...
export default function SignUp() {
  return (
  <div className="bg-white content-stretch flex flex-col items-start justify-between px-[16px] relative size-full" data-name="Sign up">
  <Frame9 />
  <Frame8 />
  </div>
  );
