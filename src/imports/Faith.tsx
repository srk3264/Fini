...
import imgCheckedCheckbox from "figma:asset/171c4d25e125328411307e42fff7c05578b730df.png";
import imgUncheckedCheckbox from "figma:asset/dd4824a7d0ed2d936e77a7d155adb6308390984f.png";
  ...
  return (
    <div className="bg-[rgba(33,33,33,0.12)] relative rounded-[100px] shrink-0 w-full" data-name="loader">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center pr-[208px] relative w-full">
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      ...
      <p className="font-['DM_Sans:Regular',sans-serif] font-normal leading-[1.3] relative shrink-0 text-[12px] text-[rgba(0,0,0,0.6)] w-full" style={{ fontVariationSettings: "'opsz' 14" }}>
...
function Frame10() {
  return (
    <div className="bg-[rgba(255,207,72,0.38)] relative rounded-[100px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[12px] py-[8px] relative w-full">
          <div className="relative shrink-0 size-[24px]" data-name="Checked Checkbox">
...
function Frame11() {
  return (
    <div className="relative rounded-[100px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[12px] py-[8px] relative w-full">
          <div className="relative shrink-0 size-[24px]" data-name="Unchecked Checkbox">
            <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgUncheckedCheckbox} />
          </div>
          <p className="flex-[1_0_0] font-['DM_Sans:Regular',sans-serif] font-normal leading-[22px] min-h-px min-w-px relative text-[17px] text-black" style={{ fontVariationSettings: "'opsz' 14" }}>
            Christianity
          </p>
